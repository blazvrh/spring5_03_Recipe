...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacamoleRecipe.addIngredient(new Ingredient("ripe avocados", BigDecimal.valueOf(2), uomEach));
        guacamoleRecipe.addIngredient(new Ingredient("kosher salt, plus more to taste", BigDecimal.valueOf(0.5), uomTeaspoon));
        guacamoleRecipe.addIngredient(new Ingredient("fresh lime or lemon juice", BigDecimal.valueOf(1), uomTablespoon));
        guacamoleRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", BigDecimal.valueOf(3), uomTablespoon));
        guacamoleRecipe.addIngredient(new Ingredient("serrano (or jalapeño) chilis, stems and seeds removed, minced", BigDecimal.valueOf(2), uomEach));
        guacamoleRecipe.addIngredient(new Ingredient("cilantro (leaves and tender stems), finely chopped", BigDecimal.valueOf(2), uomTablespoon));
        guacamoleRecipe.addIngredient(new Ingredient("freshly ground black pepper", BigDecimal.valueOf(1), uomPinch));
        guacamoleRecipe.addIngredient(new Ingredient("ripe tomato, chopped (optional)", BigDecimal.valueOf(0.5), uomEach));
        guacamoleRecipe.addIngredient(new Ingredient("Red radish or jicama slices for garnish (optional)", BigDecimal.valueOf(1), uomEach));
        guacamoleRecipe.addIngredient(new Ingredient("Tortilla chips, to serve", BigDecimal.valueOf(6), uomEach));

        tacoRecipe.addIngredient(new Ingredient("ancho chili powder", BigDecimal.valueOf(2), uomTablespoon));
        tacoRecipe.addIngredient(new Ingredient("dried oregano", BigDecimal.valueOf(1), uomTablespoon));
        tacoRecipe.addIngredient(new Ingredient("dried cumin", BigDecimal.valueOf(1), uomTablespoon));
        tacoRecipe.addIngredient(new Ingredient("sugar", BigDecimal.valueOf(1), uomTeaspoon));
        tacoRecipe.addIngredient(new Ingredient("kosher salt", BigDecimal.valueOf(0.5), uomTeaspoon));
        tacoRecipe.addIngredient(new Ingredient("garlic, finely chopped", BigDecimal.valueOf(1), uomClove));
        tacoRecipe.addIngredient(new Ingredient("finely grated orange zest", BigDecimal.valueOf(1), uomTablespoon));
        tacoRecipe.addIngredient(new Ingredient("fresh-squeezed orange juice", BigDecimal.valueOf(3), uomTablespoon));
        tacoRecipe.addIngredient(new Ingredient("olive oil", BigDecimal.valueOf(2), uomTablespoon));
        tacoRecipe.addIngredient(new Ingredient("skinless, boneless chicken thighs (1 1/4 pounds)", BigDecimal.valueOf(6), uomEach));
        tacoRecipe.addIngredient(new Ingredient("small corn tortillas", BigDecimal.valueOf(8), uomEach));
        tacoRecipe.addIngredient(new Ingredient("packed baby arugula (3 ounces)", BigDecimal.valueOf(3), uomCup));
        tacoRecipe.addIngredient(new Ingredient("medium ripe avocados, sliced", BigDecimal.valueOf(2), uomEach));
        tacoRecipe.addIngredient(new Ingredient("radishes, thinly sliced", BigDecimal.valueOf(4), uomEach));
        tacoRecipe.addIngredient(new Ingredient("cherry tomatoes, halved", BigDecimal.valueOf(0.5), uomPint));
        tacoRecipe.addIngredient(new Ingredient("red onion, thinly sliced", BigDecimal.valueOf(0.25), uomEach));
        tacoRecipe.addIngredient(new Ingredient("Roughly chopped cilantro", BigDecimal.valueOf(1), uomEach));
        tacoRecipe.addIngredient(new Ingredient("sour cream", BigDecimal.valueOf(0.5), uomCup));
        tacoRecipe.addIngredient(new Ingredient("milk", BigDecimal.valueOf(0.25), uomCup));
        tacoRecipe.addIngredient(new Ingredient("lime, cut into wedges", BigDecimal.valueOf(1), uomEach));
